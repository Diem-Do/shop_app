...
import 'package:admin_shoppingapp/models/categories_model.dart';
                            ...
                            actions: [
                              TextButton(
                                  onPressed: () async {
                                    ...
                                    bool hasProducts = await DbService()
                                        .categoryHasProducts(
                                    ...
                                    if (hasProducts) {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                              "Cannot delete category '${categories[index].name}' because it contains products"),
                                          backgroundColor: Colors.red,
                                        ),
                                      );
                                    } else {
                                      // If no products, show confirmation dialog
                                      showDialog(
                                          context: context,
                                          builder: (context) =>
                                              AdditionalConfirm(
